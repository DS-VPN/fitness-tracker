...
async function writeCatalog() {
	...
	const header = `// AUTO-GENERATED by scripts/import-off-dump.mjs — do not edit by hand.
// Every Norwegian food product in the Open Food Facts export with complete, sanity-checked
// nutrition (per 100 g, or 100 ml for beverages). Used by the shared add-on-demand catalog.
//
